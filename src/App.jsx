...
function App() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Bunk Buddy - Attendance Calculator',
        text: 'Check out this cool attendance calculator!',
    ...
    <div>
      <div className={`min-h-screen flex flex-col items-center justify-center transition-colors duration-500 ${
        ...
        <div className="fixed top-0 left-0 right-0 flex justify-between items-center p-4 z-10">
          ...
          {/* GitHub Star Button */}
          <a 
            href="https://github.com/creation22/Bunk" 
            target="_blank" 
        ...
        <div className={`${
          ...
          } backdrop-blur-md p-4 sm:p-8 rounded-3xl shadow-2xl w-full max-w-lg border transition-all duration-300 mx-4`}>
          
          {/* Header with Dark Mode Toggle */}
          <div className="flex justify-between items-center mb-6">
            <h1 className={`text-3xl sm:text-4xl font-extrabold italic ${
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="fixed bottom-4 right-4 bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-4 py-2 rounded-full font-bold shadow-lg transition-all duration-300 flex items-center gap-2"
        >
          ☕ Buy me a coffee
        </a>
      </div>
